...
from src.sbir_cet_classifier.evaluation.ab_testing import (
...
class TestSolicitationEnhancementTester:
    ...
    def sample_solicitation_data(self):
        ...
        return {
            ...
            "SOL-002": {
                "full_text": "Machine learning systems for autonomous decision making"
            }
        }
    ...
    def test_solicitation_enhancement_test(self, enhancement_tester, mock_classifiers, 
                                         sample_awards, sample_solicitation_data):
    ...
    def test_enhancement_without_solicitation_data(self, enhancement_tester, mock_classifiers, sample_awards):
