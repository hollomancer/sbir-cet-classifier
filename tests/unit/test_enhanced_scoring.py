...
class TestEnhancedCETClassifier:
    ...
    def test_classifier_initialization(self, classifier):
        ...
        assert classifier.solicitation_weight + classifier.abstract_weight + classifier.keywords_weight == 1.0
    ...
    def test_solicitation_text_disabled(self):
        ...
        classifier = EnhancedCETClassifier(
            include_solicitation_text=False,
            abstract_weight=0.7,
            keywords_weight=0.3
        )
...
class TestSolicitationEnhancedScorer:
    ...
    def test_enhance_award_with_solicitation(self, scorer, sample_award, sample_solicitation):
        ...
        assert enhanced_award["solicitation_cet_scores"] == sample_solicitation["cet_relevance_scores"]
    ...
    def test_combine_scores_with_solicitation_boost(self, scorer):
        ...
        assert abs(combined_scores["artificial_intelligence"] - base_scores["artificial_intelligence"]) < 0.1
    ...
    def test_batch_enhancement(self, scorer):
        ...
        solicitations = {
            "S1": {"solicitation_id": "S1", "full_text": "Quantum text", "cet_relevance_scores": {"quantum_computing": 0.9}},
            "S2": {"solicitation_id": "S2", "full_text": "AI text", "cet_relevance_scores": {"artificial_intelligence": 0.9}}
        }
...
class TestMultiSourceTextVectorizer:
    ...
    def test_vectorizer_fit(self, vectorizer, sample_documents):
        ...
        assert hasattr(vectorizer, 'abstract_vectorizer_')
        assert hasattr(vectorizer, 'keywords_vectorizer_')
        assert hasattr(vectorizer, 'solicitation_vectorizer_')
    ...
    def test_weighted_combination(self, vectorizer, sample_documents):
        ...
        abstract_X = vectorizer.abstract_vectorizer_.transform([doc["abstract"] for doc in sample_documents])
        keywords_X = vectorizer.keywords_vectorizer_.transform([doc["keywords"] for doc in sample_documents])
        solicitation_X = vectorizer.solicitation_vectorizer_.transform([doc["solicitation_text"] for doc in sample_documents])
