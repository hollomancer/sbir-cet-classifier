...
class TestConfidenceScorer:
    ...
    def test_uei_only_match_score(self, scorer):
        ...
        # UEI match should give high confidence even without other factors
        assert score >= 0.7
        assert score < 1.0
    ...
    def test_score_normalization(self, scorer):
        ...
        test_cases = [
            {MatchFactor.UEI_EXACT: True, MatchFactor.NAME_EXACT: True, MatchFactor.AWARD_NUMBER_EXACT: True},
    ...
    def test_confidence_thresholds(self, scorer):
        ...
        low_confidence_factors = {
            MatchFactor.NAME_SIMILARITY: 0.4
        }
