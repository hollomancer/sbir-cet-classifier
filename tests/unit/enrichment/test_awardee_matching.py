...
class TestUEIMatcher:
    ...
    def test_uei_mismatch(self, uei_matcher):
        ...
        sam_entity = {
            "ueiSAM": "XYZ789GHI012",
            "legalBusinessName": "Different Company"
        }
...
class TestFuzzyNameMatcher:
    ...
    def test_fuzzy_name_match(self, name_matcher):
        ...
        sam_entity = {
            "ueiSAM": "ABC123DEF456",
            "legalBusinessName": "Tech Innovations, LLC"  # Slight difference
        }
    ...
    def test_name_normalization(self, name_matcher):
        ...
        award_data = {
            "award_id": "AWARD-001",
            "awardee_name": "TECH INNOVATIONS, INC."
        }
        
        sam_entity = {
            "ueiSAM": "ABC123DEF456",
            "legalBusinessName": "Tech Innovations Inc"
        }
...
class TestAwardeeDataMatcher:
    ...
    def test_batch_matching(self, data_matcher, mock_sam_client):
        ...
        awards = [
            ...
            {
                "award_id": "AWARD-002",
                "awardee_name": "Company B",
                "awardee_uei": "XYZ789GHI012"
            }
        ]
