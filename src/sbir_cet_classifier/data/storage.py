...
# Placeholder classes for models not yet implemented
class ProgramOffice:
    pass

class AwardModification:
    pass
...
class EnrichedDataWriter:
    ...
    def __init__(self, data_dir: Path):
        ...
        self.awardee_writer = AwardeeProfileWriter(
            self.data_dir / "awardee_profiles.parquet"
        )
        self.program_writer = ProgramOfficeWriter(
            self.data_dir / "program_offices.parquet"
        )
        self.solicitation_writer = SolicitationWriter(
            self.data_dir / "solicitations.parquet"
        )
