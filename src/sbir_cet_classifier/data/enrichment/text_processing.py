...
class TechnicalKeywordExtractor:
    ...
    def __init__(self):
        ...
        self.technical_terms = [
            ...
            "interface", "network", "sensor", "device", "component"
        ]
    ...
    def extract_technical_phrases(self, text: str) -> List[str]:
        ...
        technical_phrase_pattern = r'\b(?:[A-Za-z]+\s+){0,2}(?:' + '|'.join(self.technical_terms) + r')\b'
    ...
    def filter_domain_specific_terms(self, terms: List[str]) -> List[str]:
        ...
        exclude_terms = {
            "project management", "team collaboration", "budget planning",
            "schedule", "timeline", "meeting", "report", "documentation",
...
class CETRelevanceScorer:
    ...
    def __init__(self):
        ...
        self.cet_categories = {
            "quantum_computing": {
                "keywords": ["quantum", "qubit", "superposition", "entanglement", "quantum algorithm"],
                "weight": 1.0
            },
            "artificial_intelligence": {
            ...
            "biotechnology": {
                "keywords": ["biotechnology", "bioengineering", "synthetic biology", "bioinformatics"],
                "weight": 1.0
            },
            "autonomous_systems": {
    ...
    def get_top_relevant_categories(self, scores: Dict[str, float], top_n: int = 5) -> List[Tuple[str, float]]:
